        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              ...
              <div className="pt-3 border-t border-border/60 text-[11px] text-muted-foreground space-y-1.5">
                <div className="flex items-center gap-2">
            ...
            <CardContent>
              <div className="text-xs text-muted-foreground space-y-2">
                <div className="flex justify-between">
                  <span>Stage:</span>
                  <span className="text-primary font-semibold">First Floor Level</span>
                </div>
                <div className="flex justify-between">
              ...
              >
                ...
                <div className="relative aspect-16/10 bg-muted w-full overflow-hidden">
                  ...
                  <div className="absolute top-2.5 left-2.5 flex items-center gap-1.5">
                    <Badge variant="outline" className="bg-background/80 backdrop-blur-md text-[10px] text-primary border-primary/20 font-semibold">
                      {proj.projectCode || "DT-PROJ"}
                    </Badge>
                    <Badge
                      variant={proj.isPublished ? "success" : "warning"}
                      className="backdrop-blur-md text-[10px] font-medium"
                    >
                ...
                <div className="p-5 flex-1 flex flex-col justify-between">
                  ...
                  <div className="pt-4 mt-4 border-t border-border/60 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      <Button variant="ghost" size="sm" asChild className="h-7 px-2 text-[11px] text-muted-foreground hover:text-foreground">
                        <Link href={`/projects/${proj.slug}`} target="_blank">
                          View
                        </Link>
                      </Button>
                      <span className="text-border">•</span>
                      <Button variant="ghost" size="sm" asChild className="h-7 px-2 text-[11px] text-primary font-semibold hover:text-primary hover:bg-primary/10">
