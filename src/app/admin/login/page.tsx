      ...
      <div className="w-full max-w-sm relative z-10">
        ...
        <div className="grid grid-cols-3 gap-3 mb-8">
          {[1, 2, 3, 4, 5, 6, 7, 8, 9].map((num) => (
            <button
              ...
              disabled={loading}
              className="h-16 rounded-xl bg-white/[0.03] hover:bg-[#C9A84C]/10 border border-white/10 hover:border-[#C9A84C]/40 text-xl font-mono text-[#F9F6F0] active:scale-95 transition-all flex items-center justify-center backdrop-blur-sm shadow-sm"
            >
              {num}
            </button>
          ))}
          <button
            ...
            onClick={handleClear}
            disabled={loading}
            className="h-16 rounded-xl bg-white/[0.02] hover:bg-white/[0.05] border border-white/5 text-xs font-mono uppercase tracking-wider text-[#8A8A8A] active:scale-95 transition-all flex items-center justify-center"
          >
            Clear
          </button>
          <button
            ...
            disabled={loading}
            className="h-16 rounded-xl bg-white/[0.03] hover:bg-[#C9A84C]/10 border border-white/10 hover:border-[#C9A84C]/40 text-xl font-mono text-[#F9F6F0] active:scale-95 transition-all flex items-center justify-center backdrop-blur-sm"
          >
            0
          </button>
          <button
        ...
        <div className="text-center">
          ...
          <div className="mt-4">
            <Link
              href="/"
              className="text-xs text-[#8A8A8A] hover:text-[#C9A84C] transition-colors underline underline-offset-4"
            >
