...
export const architecturalProjects: Project[] = [
  {
    ...
    fullCaseStudy: {
      ...
      designConcept:
        "The building massing is defined by two interlocking geometric volumes: a bold, dark textured brickwork tower framing a dramatic double-height glass curtain wall, counterbalanced by a crisp white cantilevered first-floor balcony.",
